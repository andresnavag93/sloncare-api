class DoctorOneSerializer < ActiveModel::Serializer
  attributes :id, :name, :lastname, :document, :businessname, :email, :rif, :rifnumber,
    ...
    :c1_cellphone, :c1_email, :c2_name, :c2_workstation, 
    :c2_localphone, :c2_cellphone, :c2_email, :picture, :line_1, 
    :line_2, :country_id,  :country,  :state_id,  :state, 
    :city_id, :city, :zipcode, :locale_id, :mh_permit_id, :subespecialty_field, :ms_id, 
    :cc_localphone,
    :cc_c1_localphone,
    :cc_c2_localphone,
    :cc_cellphone,
