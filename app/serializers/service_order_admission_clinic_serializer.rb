class ServiceOrderAdmissionClinicSerializer < ActiveModel::Serializer
  #Order Info
  ...
  #Status Caused
    ...
    :indications, :indications_comments,  
    :medical_report, :diagnosis,  :evolutionary_report, 
    :egress_report, :egress_date,
    :high,
    :assigned_area, :income,
  #Records
    :items, 
    :wallet 
